...
public class ViewPagerAdapter_Attend extends FragmentPagerAdapter {
    private ArrayList<Fragment> fragmentData;

    public ViewPagerAdapter_Attend(FragmentManager fm) {
        super(fm);
        fragmentData = new ArrayList<>();
        fragmentData.add(new Fragment_Attend());
